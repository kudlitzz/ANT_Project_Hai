...
{
    class ANT_HAI_RPT_ReceiptList : IReportInfo_Version_1_1
    {
        ...
        {  
            ...
            if (FirstSelectID != "")
            {
                sqlText = "select r.* from LV_Receipt t with(nolock) cross apply [ANT_F_HAI_RPT_ReceiptList](rct_ID) r where t.rct_ID in (" + SelectID + ") ";
